...
<HeroProduct project={data.project} />
{#each data.project.sections as section, index}
	<ProjectTextSection
		{section}
		leadingSpace={index === data.project.sections.length - 1 && index > 0}
	/>
	{#if index === 1 && data.project.secondaryImage}
